...
const rows={user_roles:[{user_id:user.id,role:'operator'}],businesses:[business],profiles:[{id:user.id,full_name:'Test Operator',phone:business.phone}],listings:[],business_images:[],listing_images:[],booking_enquiries:[],payment_references:[],availability:[],reviews:[],review_responses:[],promotions:[],public_transport_locations:[],public_transfer_routes:[]};
