...
try {
  ...
  assert.match(stayResultText,/\$200\.00|\$50\.00 published reference/,'stay card must show either its deterministic trip calculation or an honest pending-price reference');
