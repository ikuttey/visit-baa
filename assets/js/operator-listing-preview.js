...
async function init(){
  ...
  const raw=sessionStorage.getItem('visit_baa_listing_preview');
  ...
  let snap;try{snap=JSON.parse(raw);}catch{root.innerHTML='<div class="preview-empty"><h1>Preview data could not be read</h1></div>';return;}
